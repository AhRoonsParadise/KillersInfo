...
*	This plugin was slightly modified by Ah_Roon!
* 
*	 Change log:
...
*		1.5.0 - (Community Update) Replaced outdated Color include with Multi Colors by Bara
*/
...
public Plugin:myinfo =
{
	...
	author = "toazron1(Formerly Nut), Ah_Roon",
	description = "Shows the killer's information after you die.",
	version = VERSION,
